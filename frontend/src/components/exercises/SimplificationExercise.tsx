...
import { gcd, simplify, generateRandomFraction } from './exerciseUtils';
...
export function SimplificationExercise() {
  ...
  const [questions, setQuestions] = useState(() => Array.from({ length: TOTAL_QUESTIONS }, generateFraction));
  ...
  const handleSubmit = useCallback(() => {
    ...
    const correct =
      improperNum === q.simplestNumerator &&
      den === q.simplestDenominator;
